...
const chartOptions = computed(() => {
    return {
        ...
        xaxis: {
            categories: ["Jun", "Jul", "Aug", "Sepr", "Oct", "Novr", "Dec"],
            axisBorder: {
                show: false,
            },
            axisTicks: {
            ...
            <div>
                ...
                <div class="d-flex align-center mt-2 gap-4">
                    <div class="d-flex align-center">
                        ...
                        <div>
                            <h6 class="text-h6 font-weight-semibold d-flex align-center">36,436 <v-chip color="success" class="bg-lightsuccess ml-1" variant="outlined" size="x-small">+82%</v-chip></h6>
                            <p class="text-subtitle-1 text-grey100 font-weight-medium">New Users</p>
                        </div>
                    </div>
                </div>
            </div>
